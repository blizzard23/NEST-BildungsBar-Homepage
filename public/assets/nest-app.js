...
window.NUR_ESSEN = [
  ...
  "elektroniker-fuer-gebaeude-und-infrastruktursysteme",
  "studium-arboristik",
...
window.BERUF_BILDER = {
  ...
  "elektroniker-fuer-gebaeude-und-infrastruktursysteme": "assets/img/berufe/elektroniker-fuer-gebaeude-und-infrastruktursysteme.png",
...
window.UNTERNEHMEN = {
  ...
  "Vorwerk Autotec": "https://career.vorwerk-sohn.com/",
  ...
  "BS Rollen": "https://bs-rollen.com/de/de/karriere-ausbildung/ausbildung/",
  "Diakonische Altenhilfe": "https://www.diakonie-akademie.de/ausbildung",
  "Schulten Gebäudedienste": "https://schulten.de/ausbildung-bei-schulten/"
};
...
window.BERUFE_KATEGORIEN = [
  ...
  },
  {
    ...
    berufe: [
      ...
      { name: "Elektroniker:in für Gebäude- und Infrastruktursysteme", dauer: "3,5 Jahre", info: "Als Elektroniker:in für Gebäude- und Infrastruktursysteme richtest du die technische Infrastruktur ganzer Gebäude ein: Energieversorgung, Beleuchtung und Datennetze ebenso wie Sicherheitstechnik, etwa Brandmelde- und Alarmanlagen. Du installierst die Systeme, nimmst sie in Betrieb, prüfst sie regelmäßig und behebst Störungen.", partner: ["Minimax"], standorte: ["Essen"] },
      ...
      { name: "Gebäudereiniger:in", dauer: "3 Jahre", info: "Als Gebäudereiniger:in sorgst du dafür, dass Gebäude sauber, gepflegt und werterhalten bleiben: Du reinigst Büros, Schulen, Kliniken und Produktionshallen, pflegst Böden, Fassaden und Glasflächen und arbeitest dabei mit Spezialmaschinen, Reinigungs- und Hebetechnik. Du wählst passende Verfahren und Mittel aus, achtest auf Hygiene- und Arbeitsschutzvorschriften und betreust Kund:innen vor Ort.", partner: ["Schulten Gebäudedienste"] },
  ...
  },
  {
    ...
    berufe: [
      ...
      { name: "Duales Studium Wirtschaftsingenieurwesen", dauer: "3–4 Jahre (B. Sc.)", info: "Im dualen Studium Wirtschaftsingenieurwesen verbindest du technisches und betriebswirtschaftliches Wissen: Du analysierst und optimierst Produktions- und Geschäftsprozesse, planst Projekte und arbeitest an der Schnittstelle zwischen Technik und Management – im Wechsel zwischen Hochschule und Unternehmenspraxis.", partner: ["Vorwerk Autotec"] },
      ...
      { name: "Fachinformatiker:in Anwendungsentwicklung", dauer: "3 Jahre", info: "Als Fachinformatiker:in für Anwendungsentwicklung entwickelst du Software nach Kundenvorgaben: Du programmierst, testest und optimierst Lösungen, bleibst über aktuelle Technologien informiert und unterstützt Unternehmen bei der Prozessoptimierung.", partner: ["Vorwerk", "Stadt Wuppertal", "Barmenia Versicherungen", "Wuppertaler Stadtwerke", "WASI", "E/D/E", "optadata"] },
      ...
      { name: "Industriemechaniker:in", dauer: "3,5 Jahre", info: "Als Industriemechaniker:in baust, wartest und reparierst du Maschinen und Produktionsanlagen: Du fertigst Bauteile durch Feilen, Bohren, Drehen, Fräsen und Schweißen, montierst Anlagen aus Einzelteilen und richtest sie ein. Bei Störungen suchst du mit Messgeräten und Diagnosesoftware nach der Ursache, tauschst verschlissene Teile aus und hältst die Anlagen im laufenden Betrieb instand – je nach Einsatzgebiet in Feingerätebau, Instandhaltung, Maschinen- und Anlagenbau oder Produktionstechnik.", partner: ["Wupperverband", "Erfurt", "WKW Group", "Gebrüder Becker", "Gebr. Schmidt", "Knipex", "Stahlwille", "Walther Pilot", "Karl Deutsch", "Wuppertaler Stadtwerke", "Muckenhaupt & Nusselt", "Wilkinson Sword", "AWG", "Emil Kreiskott GmbH"] },
  ...
  },
  {
    ...
    berufe: [
      ...
      { name: "Duales Studium Business Administration", dauer: "3 Jahre", info: "Das Studium vermittelt betriebswirtschaftliche Kenntnisse in Marketing, Finanzwesen, Personalmanagement und Unternehmensführung – im Wechsel aus Hochschultheorie und Praxis im Unternehmen.", partner: ["Fohrer", "Wilkinson Sword", "Freund", "optadata"] },
      ...
      { name: "Fachkraft für Lagerlogistik", dauer: "3 Jahre", info: "Als Fachkraft für Lagerlogistik organisierst und verwaltest du Waren: Wareneingang, Bestandskontrolle, Kommissionierung und Versand – eine vielseitige Rolle zwischen Lager und Büro.", partner: ["Erfurt", "WASI", "Gebrüder Becker", "Knipex", "PE Automotive", "Coroplast", "Metaq", "Freund", "Procar Automobile", "Stadt Wuppertal", "WKW Group", "Conmetall Meister", "Wiesemann & Theis", "Kaut", "E/D/E", "BS Rollen"] },
      ...
      { name: "Fachlagerist:in", dauer: "2 Jahre", info: "Als Fachlagerist:in verwaltest du Waren: Du lagerst ein, kommissionierst und hältst die Lagerplätze ordentlich – mit praktischer Lagerarbeit und Büroaufgaben.", partner: ["Schmersal", "Conmetall Meister", "Beuthel", "GEPA", "E/D/E", "BS Rollen"] },
      { name: "Kaufleute Büromanagement", dauer: "3 Jahre", info: "Als Kaufmann/-frau für Büromanagement organisierst du Büroabläufe: Du bearbeitest Schriftverkehr, planst Termine, unterstützt die Buchhaltung, koordinierst Kommunikation und kümmerst dich um Personalverwaltung und Veranstaltungen.", partner: ["Peter Barth GmbH", "Erfurt", "Autohaus Lackmann", "Wupperverband", "Vorwerk", "Mencke", "Coroplast", "Karl Deutsch", "Stahlwille", "Wuppertaler Stadtwerke", "Beuthel", "Alex & Greiff GmbH", "Martin GmbH", "optadata", "Schulten Gebäudedienste"] },
...
var ERWARTET_KW = [
  ...
  [["gebäudereinig", "reinig"], "Arbeit in Gebäuden mit professioneller Reinigungs- und Maschinentechnik"],
...
var MITBRINGEN_KW = [
  ...
  [["gebäudereinig", "reinig"], "Ein Auge für Sauberkeit und Freude an sichtbaren Ergebnissen"],
